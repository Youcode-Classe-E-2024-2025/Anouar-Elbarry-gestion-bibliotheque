    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden transform transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                <div class="relative">
                    <img src="/api/placeholder/400/300" alt="The Great Gatsby" 
                ...
                <div class="p-6">
                    <div class="flex justify-between items-start mb-4">
                        <h2 class="text-2xl font-bold text-gray-900">The Great Gatsby</h2>
                        <div class="flex text-yellow-400">
                            ★★★★☆
                        </div>
                    </div>
                    <p class="text-gray-600 mb-4">F. Scott Fitzgerald</p>
                    <p class="text-gray-700 mb-6">A story of decadence and excess, Gatsby explores the American Dream in the Jazz Age of the 1920s.</p>
                    <div class="flex justify-between items-center">
                        <span class="text-sm text-gray-500">Available Copies: 3</span>
                        <a href="/books/details" class="bg-black text-white px-6 py-2 rounded-lg hover:bg-gray-800 transition duration-300">
                            View Details
                        </a>
                    </div>
                </div>
